...
class DemoQATest:
    ...
    def click_on_new_window(self):
        new_tab_ele = self.page.locator("//button[text()='New Window']")
        new_tab_ele.click()
        time.sleep(2)

    def handle_browser_window(self):
        with self.page.expect_popup() as new_window_info:
            pass
...
if __name__ == '__main__':
    ...
    demo_obj.remove_ads()
    demo_obj.click_on_new_window()
    demo_obj.handle_browser_window()
