"""
method: set_input_files("#uploadFile", "test.txt")
"""
import time
...
class DemoQATest:
    ...
    def select_elements_tab(self):
        ...
        elements_section = self.page.locator("//*[text()='Elements']")
        elements_section.click()
        time.sleep(5)
        self.file_upload()

    def file_upload(self):
        self.page.locator("//*[text()='Upload and Download']").click()
        time.sleep(5)
        self.page.set_input_files("//*[@id='uploadFile']", r"\demo_test.py")
        time.sleep(5)
